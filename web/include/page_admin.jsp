...
<div class="alert alert-info">
	<span>第${pg['firstRow']} - ${pg['lastRow'] }条记录 / 共${pg['pages'] }页 ${pg['count'] }条</span>

	<span>
		<div class="btn-group" data-toggle="buttons">
		  <label class="btn btn-default">
		    <input type="radio" name="radioPages" value="10" onchange="reflush();"> 10行
		  </label>
		  <label class="btn btn-default">
		    <input type="radio" name="radioPages" value="20" onchange="reflush();"> 20行
		  </label>
		  <label class="btn btn-default">
		    <input type="radio" name="radioPages" value="50" onchange="reflush();"> 50行
		  </label>
		  <label class="btn btn-default">
		    <input type="radio" name="radioPages" value="100" onchange="reflush();"> 100行
		  </label>
		</div>
	</span>
</div>
