    ...
    <script>
        $(document).ready(function(){
            ...
            $('#btnBack').click(function(){
                location.href = "${ctx}/admin/photo/list";
            });

            $('#btnSave').click(function() {
                $('#photoForm').validation();
                if ($("#photoForm").valid() == false){
                } else {
                    var opt = $('#opt').val();
                    if("add"==opt) {
                        $("#photoForm").attr("action", "${ctx}/admin/photo/add");
                    } else if("modify"==opt) {
                        $("#photoForm").attr("action", "${ctx}/admin/photo/modify");
                    }
                    $("#photoForm").submit();
                }
            });
            ...
            <div class="panel panel-primary">
                ...
                <div id="collapse2" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <fieldset>
                            <form class="form-horizontal" action="#" id="photoForm" method="post" enctype="multipart/form-data">
                                <input type="hidden" id="pid" name="pid" value="${photo.pid}"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" id="title" name="title" value="${photo.title}" placeholder="此为必填项" maxlength="20" check-type="required" autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="src">照片</label>
                                    <div class="col-sm-6">
                                        ...
                                        <input class="form-control" type="text" id="src" name="src" value="${photo.src}" readonly>
                                        <input class="form-control" type="text" id="pre" name="pre" value="${photo.pre}" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="width">原图长宽</label>
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" id="width" name="width" value='${photo.width}' readonly> *
                                        <input class="form-control" type="text" id="height" name="height" value='${photo.height}' readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="createtime">创建时间</label>
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" id="createtime" name="createtime" value='<fmt:formatDate value="${photo.createtime}" type="both"/>' readonly>
                                    </div>
                                </div>
                            </form>
                            <div class="well">
