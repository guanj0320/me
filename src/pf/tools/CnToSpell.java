...
public class CnToSpell {   
    ...
    public static String getSpellAddKG(String cnStr, boolean onlyFirstSpell) {   
        if (cnStr == null) {   
            return "";   
        }   
    ...
    public static void main(String[] args) {   
        ...
        for (int i = 0; i < s.length; i++) {   
            ...
            System.out.println(s[i]+" 的全拼:" + getSpellAddKG(s[i], false));   
            System.out.println(s[i]+" 的首拼:" + getSpellAddKG(s[i], true));   
