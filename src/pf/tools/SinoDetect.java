...
public class SinoDetect {
	...
	/**
	 * 
	 * 此方法作用，这个方法查看URL并就每种编码类型分配给这个URL一个概率，返回最高概率的那个编码类型
	 * 
	 * @return int  返回概率最高的编码类型
	 * @param testurl  传入的url
	 * 
	 */
	...
	/**
	 * 此方法作用，这个方法查看一个文件并就每种编码类型分配给这个文件一个概率，返回最高概率的那个编码类型
	 * 
	 * @return int  返回概率最高的编码类型
	 * @param testfile  传入的文件
	 * 
	 */
	...
	/**
	 * 此方法作用，这个方法查看一个字节数组并就每种编码类型分配给这个字节数组一个概率，返回最高概率的那个编码类型
	 * 
	 * @return int  返回概率最高的编码类型
	 * @param rawtext  传入的字节数组
	 * 
	 */
	 ...
	 */
	/**
	 * 此方法作用，这个方法使用1到100的数字来表示数组内的文本使用GB-2312编码的概率，返回这个概率
	 * 
	 * @return int  返回数组内文本使用GB-2312编码的概率
	 * @param rawtext 传入的字节数组
	 * 
	 */
	 ...
	 */
	/**
	 * 此方法作用，这个方法使用1到100的数字来表示数组内的文本使用GBK编码的概率，返回这个概率
	 * 
	 * @return int  返回数组内文本使用GBK编码的概率
	 * @param rawtext  传入的字节数组
	 * 
	 */
	...
	/**
	 * 此方法作用，这个方法使用1到100的数字来表示数组内的文本使用HZ编码的概率，返回这个概率
	 * 
	 * @return int  返回数组内文本使用HZ编码的概率
	 * @param rawtext  传入的字节数组
	 * 
	 */
	 ...
	 */
	/**
	 * 此方法作用，这个方法使用1到100的数字来表示数组内的文本使用BIG5编码的概率，返回这个概率
	 * 
	 * @return int  返回数组内文本使用BIG5编码的概率
	 * @param rawtext  传入的字节数组
	 * 
	 */
	...
	/**
	 * 此方法作用，这个方法使用1到100的数字来表示数组内的文本使用EUC_TW编码的概率，返回这个概率
	 * 
	 * @return int  返回数组内文本使用EUC_TW编码的概率
	 * @param rawtext  传入的字节数组
	 * 
	 */
	 ...
	 */
	/**
	 * 此方法作用，这个方法使用1到100的数字来表示数组内的文本使用ISO_2022_CN编码的概率，返回这个概率
	 * 
	 * @return int  返回数组内文本使用ISO_2022_CN编码的概率
	 * @param rawtext  传入的字节数组
	 * 
	 */
	 ...
	 */
	/**
	 * 此方法作用，这个方法使用1到100的数字来表示数组内的文本使用UTF_8编码的概率，返回这个概率
	 * 
	 * @return int  返回数组内文本使用UTF_8编码的概率
	 * @param rawtext  传入的字节数组
	 * 
	 */
	 ...
	 */
	/**
	 * 此方法作用，这个方法使用1到100的数字来表示数组内的文本使用UTF_16编码的概率，返回这个概率
	 * 
	 * @return int  返回数组内文本使用UTF_16编码的概率
	 * @param rawtext  传入的字节数组
	 * 
	 */
	 ...
	 */
	/**
	 * 此方法作用，这个方法使用1到100的数字来表示数组内的文本使用ASCII编码的概率，返回这个概率
	 * 
	 * @return int  返回数组内文本使用ASCII编码的概率
	 * @param rawtext  传入的字节数组
	 * 
	 */
