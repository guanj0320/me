...
public class GB2Alpha {
	...
	public static void main(String[] args) {
		System.out.println(GB2Alpha.getFirstLetter("I love u"));
		System.out.println(GB2Alpha.getFirstLetter("我爱北京天安门"));
		System.out.println(GB2Alpha.getFirstLetter("I love 北京天安门"));
